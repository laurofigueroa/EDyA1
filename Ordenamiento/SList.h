...
/*
 * Agrega a una lista elmentos de forma ordenada.
 *
 * El invariante verifica que el siguiente elemento es mayor estricto que él mismo.
 */
SList *add_sorted(SList *,int);
...
SList *slist_remove2(SList *lista,int posicion);
